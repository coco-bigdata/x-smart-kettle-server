...
java -Djava.ext.dirs=./lib -Xms500m -Xmx1g -XX:MaxDirectMemorySize=1g -Dsun.net.client.defaultConnectTimeout=60000  -Dspring.config.location=.\config\application-dev.yml -jar smart-kettle-2021.5.jar -> ..\log\smart-kettle.log
@pause